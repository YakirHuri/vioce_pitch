...
def change_pitch(sound, factor):
    manipulation = call(sound, "To Manipulation", x1, x2, x3)
   ...
   if x == 1:
       ...
       if file_exists:
           #Read the recording if it exists and play it
            ...
            sound = parselmouth.Sound("trial.wav")
            bla = interactive_change_pitch(sound, factorrr)

            with open('trial.wav', 'wb') as f:
                f.write(bla.data)
